...
return [
    ...
    'aboutUs'=>'About us',
                ...
                'strategies'=>'our markting strategies',
    ...
    'OurBreafHistory'=>'Company Profile',
    ...
    'title'=>'Al-miqdad pharma corporation',
    'descMeta'=>'AL-MIQDAD PHARMA is a private Yemeni institution whose business activities depend on import, market and distribute the medicines and medical supplies (wholesale, retail).',
    'descKeyWord'=>'Pharmacy , Pharma , Midecen , health care , almiqdadpharma',
    'newaddonTitle1'=>'We are committed to excellence in pharmaceutical marketing, professional relationship and successful partnership. ',
    'newaddonTitle2'=>'These points enable us to offer an optimal blend to total customer care by delivering quality products and the best customer service at a competitive cost.',
    'aboutCompanyFooter'=>"<strong style='color:white !important' >Whow we are? <p><strong style='color:white !important'>Almiqdad pharma </strong> is established and formed as Yemeni private Company specialized in importing, marketing and distributing Pharmaceutical products and Medical supplies in Yemen. But it’s already in Yemen market since 2014 as a modern group of the known wholesalers and pharmacies. </p>",
];
