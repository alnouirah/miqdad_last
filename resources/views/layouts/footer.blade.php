        ...
        <div class="container">
            ...
            <div class="eco_footer_columns">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-6 responsive-devider-50">
                        <div class="eco_offices_info">
                            ...
                            <ul class="eco_admin_info">
                                <li><i class="fa fa-map-marker" aria-hidden="true"></i><p>{{ trans('language.location') }}</p></li>
                    ...
                    <div class="col-lg-4 responsive-devider-50">
                        <div class="eco_offices_info">
                            <!--<h5 class="eco_sm_titles logoFooter">{{ trans('language.logoFooter') }} </h5>-->
                            <img style="margin-top: 52px;
                        width: 640px;" src="{{ asset('images/footerLogo.PNG') }}">
                        </div>
                    </div>

                    <div class="col-lg-4 responsive-devider-50">
                        {!! trans('language.aboutCompanyFooter')  !!}
                    </div>
...
$('.contactUsButton').on('click',function(){
    ...
    window.location.href = 'https://mail.google.com/mail/u/0/?view=cm&fs=1&to=info@almiqdadpharma.com&body='+userMessage+'/n send from : '+userEmail+'&tf=1';
