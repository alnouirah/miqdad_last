...
<html lang="en">
  <head>
	...
	<meta name='description' itemprop='description' content='{{ trans("language.descMeta") }}' />
	<meta name='keywords' content='{{ trans("language.descKeyWord") }}' />
	<meta property='article:section' content='{{ trans("language.descMeta") }}' />


    <!-- Title of this page -->
    <title>{{ trans('language.title') }}</title>
					...
					<div class="kode_navigaion_bar">
						...
						<div id="kode-responsive-navigation" class="dl-menuwrapper">
							...
							<ul class="dl-menu">
								...
								<li class="menu-item"><a href="#">{{trans('language.aboutUs')}}</a>
									<ul class="dl-submenu">				
										<li><a href="aboutUs">{{trans('language.BreifHistory')}}</a></li>
										<li><a href="aboutUs">{{trans('language.missionAndVision')}}</a></li>
										<li><a href="aboutUs">{{trans('language.Goal')}}</a></li>
									</ul>
								</li>
								<li class="menu-item"><a href="#">{{trans('language.howWeWork')}}</a>
									<ul class="dl-submenu">				
										<li><a href="aboutUs">{{trans('language.servicesAndActivities')}}</a></li>
										<li><a href="aboutUs">{{trans('language.strategies')}}</a></li>
										<li><a href="aboutUs">{{trans('language.productAndPartners')}}</a></li>
									</ul>
								</li>
								<li class="active"><a class="active" href="home">{{trans('language.contactUs')}}</a>
								</li>
								<li class="active"><a class="active" href="home">{{trans('language.findMain')}}</a>
								</li>
							</ul>
						</div>
						<!--Responsive Menu END-->
					                ...
					                <a href="home">{{trans('language.home')}}</a>
											...
											<li class="use-dropdown">
															...
															<ul class="children sub-menu">
																	...
																	<li>
																			<a href="aboutUs">{{trans('language.Goal')}}</a> 
																	</li>
																		{{-- <li>
